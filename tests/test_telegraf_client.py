...
class TestTelegrafClient:
    async def test_field(self, telegraf_client: aio_statsd.TelegrafClient, udp_server, mocker):
    ...
    async def test_tag(self, telegraf_client: aio_statsd.TelegrafClient, udp_server, mocker):
        demo_timestamp: int = 1_600_000_000 * 1000 * 1000 * 1000
        mocker.patch("aio_statsd.client.time.time", return_value=1_600_000_000)
    ...
    async def test_use_server_time(self, telegraf_client: aio_statsd.TelegrafClient, udp_server):
    ...
    async def test_special_char(self, telegraf_client: aio_statsd.TelegrafClient, udp_server, mocker):
        demo_timestamp: int = 1_600_000_000 * 1000 * 1000 * 1000
        mocker.patch("aio_statsd.client.time.time", return_value=1_600_000_000)
    ...
    async def test_tag_key_error(self, telegraf_client: aio_statsd.TelegrafClient):
